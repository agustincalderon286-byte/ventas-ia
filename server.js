  ...
  const visibleReferrals = referrals
    .map((referral, index) => {
      ...
      return {
        ...
        nextAction: visibleRecord.nextAction || "",
        nextActionAt: visibleRecord.nextActionAt || null,
        assignedTelemarketerUserId: visibleRecord.assignedTelemarketerUserId || "",
        assignedTelemarketerName: visibleRecord.assignedTelemarketerName || "",
        appointmentRepUserId: visibleRecord.appointmentRepUserId || "",
        appointmentRepName:
          visibleRecord.appointmentRepName || sheetDoc.representativeName || "",
        briefHistory: visibleRecord.briefHistory || "",
